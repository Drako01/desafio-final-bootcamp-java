...
class ClienteControllerTest {
    ...
    void testGetAllClientesSuccess() {
        ...
        clientes.add(new Cliente(1, "Juan", "juan@example.com", "123456789", null));
        clientes.add(new Cliente(2, "María", "maria@example.com", "987654321", null));
    ...
    void testGetClienteByIdSuccess() {
        Cliente cliente = new Cliente(1, "Juan", "juan@example.com", "123456789", null);
    ...
    void testUpdateClienteSuccess() {
        Cliente existingCliente = new Cliente(1, "Juan", "juan@example.com", "123456789", null);
        Cliente updatedCliente = new Cliente(1, "Juan", "juan.perez@example.com", "123456789", null);
