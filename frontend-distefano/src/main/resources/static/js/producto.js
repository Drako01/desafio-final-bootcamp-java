...
function agregarNuevoProducto() {
	...
	const inputFoto = crearInput();
	inputFoto.placeholder = 'URL de la foto';
	...
	inputDescripcion.placeholder = 'Descripción del producto';
	celdaDescripcion.appendChild(inputDescripcion);

	const celdaStock = crearCelda();
	const inputStock = document.createElement('input');
	inputStock.type = 'number';
	inputStock.style.cssText = estiloInput;
	...
	inputPrecio.style.cssText = estiloInput;
	...
	selectCategoria.id = 'categoriaId';
	selectCategoria.name = 'categoriaId';
